...
for(let i=0;i<list.length;i++){
    ...
    if(list[i][0].includes("DS"))
        newList.push({gameId: (i+1), systemId: `21`});
    if(list[i][0].includes("PSP"))
        newList.push({gameId: (i+1), systemId: `22`});
};
